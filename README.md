...
All pages, apart from posts, are static. The posts page uses CRUD operations to add, update, read, and remove posts of only one user with id=1. React Quill is used to add and update posts. Nodemailer is used to send mail from a form on the ContactPage.js. MySQL is used as the database. ORM Sequelize is also used.
