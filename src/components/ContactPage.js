...
const CONTACTS = {
  headerAddres1: "Адрес: ",
  headerAddres2:
    'Приморский край г. Артем, ул. Пушкина 16. Остановка автобуса "Дом Культуры Угольщиков"',
  ...
  return (
    <div>
      <div className="contact__header">
        ...
        <p>
          Приглашаем вас на Богослужения, каждую субботу в 11-00, по адресу г.
          Артем, ул Пушкина 16. <br /> Примите участие в радостном прославлении
          Бога, молитве и изученнии Библии. <br /> У нас вы найдёте хороших
          друзей, мы будем рады общению с вами.
        </p>
      </div>
      ...
      <div className="container">
        ...
        <div className="address__wrapper">
          ...
          {/*ADDRESS END====================================================*/}
          {/*todo bem.css строки 2212 - 2228 "раскомментировать что бы форма показалась на компах"*/}
