                            ...
                            <ul className="menu__list menu_socials">
                                ...
                                <li className="menu__item menu__item_header">
                                    <Link className="menu__link" target="_blank"
                                          href="https://rutube.ru/video/5aac7d67401e9624126964230167d953/?r=wm">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width={34}
                                            height={34}
                                        ...
                                        >
                                            {/* круг */}
                                            <circle cx="18" cy="18" r="17.28" fill="#004E98"/>
                                            {/* play + фирменная форма RuTube */}
                                            <path
                                                d="M14.6 12.8
                                             C13.6 12.2 12.6 12.9 12.6 14.1
                                             V21.9
                                             C12.6 23.1 13.6 23.8 14.6 23.2
                                             L22.2 18.8
                                             C23.1 18.3 23.1 17.7 22.2 17.2
                                             Z"
                                                fill="#FFFFFF"
                                            />
                                        </svg>
