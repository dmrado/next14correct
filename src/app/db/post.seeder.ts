...
export const up = (queryInterface: QueryInterface): Promise<void> => {
    return queryInterface.bulkInsert('posts', [
        ...
        },
        {
            ...
            preview: 'Text Post-7, Text Post-7,  reiciendis voluptatem ad',
            createdAt: new Date(),
            updatedAt: new Date(),
        },
        {
            ...
            preview: 'Text Post-8, Text Post-8,  reiciendis voluptatem adip',
            createdAt: new Date(),
            updatedAt: new Date(),
        },
        {
            ...
            preview: 'Text Post-9, Text Post-9,  reiciendis voluptatem adipi',
            createdAt: new Date(),
            updatedAt: new Date(),
        },
        {
            ...
            preview: 'Text Post-10, Text Post-10,  reiciendis voluptatem ad',
            createdAt: new Date(),
            updatedAt: new Date(),
        },
        {
            ...
            preview: 'Text Post-11, Text Post-11,  reiciendis voluptatem adipis',
            createdAt: new Date(),
            updatedAt: new Date(),
        },
        {
            ...
            preview: 'Text Post-12, Text Post-12,  reiciendis voluptatem adipiscsunt',
            createdAt: new Date(),
            updatedAt: new Date(),
        },
        {
            ...
            preview: 'Text Post-13, Text Post-13,  reiciendis voluptatem adip',
            createdAt: new Date(),
            updatedAt: new Date(),
        },
        {
            ...
            preview: 'Text Post-14, Text Post-14,  reiciendis voluptatem adipiscsunt voluptatem',
            createdAt: new Date(),
            updatedAt: new Date(),
        },
        {
            ...
            preview: 'Text Post-15, Text Post-15,  reiciendis voluptatem adipiscsunt volu',
            createdAt: new Date(),
            updatedAt: new Date(),
        },
        {
            ...
            preview: 'Text Post-16, Text Post-16, Text Post-16,Text Post-16 Text Post',
            createdAt: new Date(),
            updatedAt: new Date(),
        },
        {
